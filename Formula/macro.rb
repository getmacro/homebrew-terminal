class Macro < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/getmacro/terminal/releases/download/v0.1.5/macro-aarch64-apple-darwin.tar.gz"
      sha256 "a62100a29722f9170580c7adf7404b961c4f7e59a5c5940b91e95fb0e0504b99"
    else
      url "https://github.com/getmacro/terminal/releases/download/v0.1.5/macro-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/getmacro/terminal/releases/download/v0.1.5/macro-aarch64-linux-gnu.tar.gz"
      sha256 "f7e89648cb71ccbc279d1230a8ac1feaddc1b5ac39d3cb33ab8135abdbcc3014"
    else
      url "https://github.com/getmacro/terminal/releases/download/v0.1.5/macro-x86_64-linux-gnu.tar.gz"
